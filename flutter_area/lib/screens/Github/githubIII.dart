...
class GithubIII extends StatefulWidget {
  const GithubIII({ Key? key }) : super(key: key);

  @override
  State<GithubIII> createState() => _GithubIIIState();
}

class _GithubIIIState extends State<GithubIII> {
  String username = "";
            ...
            Form(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ConstrainedBox(
                  ...
                  child: Text(
                    "Get all commits for a specified repo",
                    style: TextStyle(
                          ...
                          action: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              res = await GithubModel()
                                  .githubCommits(username, _controller.text);
                              print(res);
                              setState(() {});
                            }
                          },
